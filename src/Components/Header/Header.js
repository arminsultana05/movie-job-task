            ...
            <div class="navbar bg-base-100 w-full">
                ...
                <div class="form-control mr-10 w-1/2 ">
                    <div class="input-group">
                        <input onChange={(e) => dataObject.setSeaechValue(e.target.value)} type="text" placeholder="Search Movies…" class="input input-bordered w-full" />
                ...
                <div class="flex-none gap-2 mr-10">
                    <div class="form-control">
                        <div class="input-group">
                            ...
                            onClick={(e)=>dataObject.setDate(e.target.value)}
